export function encodePublicBookTickerBatchV3Api(message) {
  let bb = popByteBuffer();
  _encodePublicBookTickerBatchV3Api(message, bb);
  return toUint8Array(bb);
}

function _encodePublicBookTickerBatchV3Api(message, bb) {
  ...
  if (array$items !== undefined) {
    for (let value of array$items) {
      ...
      _encodePublicBookTickerV3Api(value, nested);
...
export function decodePublicBookTickerBatchV3Api(binary) {
  return _decodePublicBookTickerBatchV3Api(wrapByteBuffer(binary));
}

function _decodePublicBookTickerBatchV3Api(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        values.push(_decodePublicBookTickerV3Api(bb));
        bb.limit = limit;
        break;
      }
