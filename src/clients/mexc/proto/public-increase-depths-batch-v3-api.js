export function encodePublicIncreaseDepthsBatchV3Api(message) {
  let bb = popByteBuffer();
  _encodePublicIncreaseDepthsBatchV3Api(message, bb);
  return toUint8Array(bb);
}

function _encodePublicIncreaseDepthsBatchV3Api(message, bb) {
  ...
  if (array$items !== undefined) {
    for (let value of array$items) {
      ...
      _encodePublicIncreaseDepthsV3Api(value, nested);
...
export function decodePublicIncreaseDepthsBatchV3Api(binary) {
  return _decodePublicIncreaseDepthsBatchV3Api(wrapByteBuffer(binary));
}

function _decodePublicIncreaseDepthsBatchV3Api(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        values.push(_decodePublicIncreaseDepthsV3Api(bb));
        bb.limit = limit;
        break;
      }
