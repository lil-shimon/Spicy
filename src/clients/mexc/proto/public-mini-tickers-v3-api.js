export function encodePublicMiniTickersV3Api(message) {
  let bb = popByteBuffer();
  _encodePublicMiniTickersV3Api(message, bb);
  return toUint8Array(bb);
}

function _encodePublicMiniTickersV3Api(message, bb) {
  ...
  if (array$items !== undefined) {
    for (let value of array$items) {
      ...
      _encodePublicMiniTickerV3Api(value, nested);
...
export function decodePublicMiniTickersV3Api(binary) {
  return _decodePublicMiniTickersV3Api(wrapByteBuffer(binary));
}

function _decodePublicMiniTickersV3Api(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        values.push(_decodePublicMiniTickerV3Api(bb));
        bb.limit = limit;
        break;
      }
